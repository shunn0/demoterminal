    ...
    render() {
        return (
            <div>
                ...
                <div className="align-center">
                    Agent : <p className="title1"> {this.state.name}</p>
                </div>
                <div className="align-center">
                    <br/><br/>
                    <table>
                        <tr>
                            <td>
                                <TextField id="outlined-basic" label="Enter Command to Run" variant="outlined"
                                           onChange={(event) => {
                            ...
                            <td>
                                <Button variant="contained" color="primary"
                                        onClick={this.sendMessage}>Run</Button>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <SockJsClient
                    url='http://34.125.135.255:8080/websocket-chat/'
